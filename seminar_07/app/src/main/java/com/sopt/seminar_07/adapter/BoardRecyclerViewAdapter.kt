package com.sopt.seminar_07.adapter
...
import com.sopt.seminar_07.DetailedBoardActivity
import com.sopt.seminar_07.R
...
class BoardRecyclerViewAdapter(val ctx: Context, val dataList: ArrayList<BoardData>)
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        holder.like_cnt.text = dataList[position].body
